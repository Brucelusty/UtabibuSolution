...
Table 172491 "Bulk SMS Header"
{
    ...
    fields
    {
        ...
        field(15; "Member Status"; Option)
        {
            OptionMembers = " ",Active,Dormant,"Awaiting Exit","Penalty balance","Registration Date",Gender,"Occupation details","Utapesa Defaulter","Employer code";
        }
