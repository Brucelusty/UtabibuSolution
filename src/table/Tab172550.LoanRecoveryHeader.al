...
Table 172550 "Loan Recovery Header"
{
    ...
    fields
    {
        ...
        field(20; "Loan to Attach"; Code[20])
        {
            ...
            begin
                ...
                "Total Interest Due Recovered2" := 0;
                ...
                if LoanRec.Find('-') then begin
                    LoanRec.CalcFields(LoanRec."Outstanding Balance", LoanRec."Outstanding Interest", LoanRec."Current Penalty Due");
                    //if (LoanRec."Outstanding Balance" > 0) or (LoanRec."Outstanding Interest" > 0) then begin
                    "Loan Liabilities" := ROUND(LoanRec."Outstanding Balance") + Round(LoanRec."Outstanding Interest") + Round(LoanRec."Current Penalty Due");
                    "Principal Repayment" := ROUND(LoanRec."Outstanding Balance");
                    "Interest Repayment" := Round(LoanRec."Outstanding Interest");
                    "Penalty Repayment" := Round(LoanRec."Current Penalty Due");
                    //Message('%1|&2%|%5%', "Loan Liabilities",LoanRec."Outstanding Interest",LoanRec."Outstanding Balance");
                    ...
                    "Total Interest Due Recovered2" := TotalPenalty;
                end;
        ...
        field(42; "Penalty Repayment"; Decimal)
        {
        }
        field(43; "Total Interest Due Recovered2"; Decimal)
        {
        }
        field(44; "Total principal repayment"; Decimal)
        {
        }
    }
    ...
    begin
        ...
        "Total principal repayment" := ObjLoans."Outstanding Balance";
    end;
}
