...
Table 172361 "Member App Nominee"
{
    ...
    fields
    {
        ...
        field(12; "%Allocation"; Decimal)
        {
            ...
            trigger OnValidate()
            begin
                if "Next Of Kin Type" <> "Next Of Kin Type"::Nominee then Error('Allocation can only be done for nominees!!!');
        ...
        field(14; "Maximun Allocation %"; Decimal)
        {
            trigger OnValidate()
            begin
                if "Next Of Kin Type" = "Next Of Kin Type"::"Next of Kin" then begin
                    Error('Only nominnee should have the allocation. Next of kin %1', "Next Of Kin Type");
                end;
            end;
        }
        ...
        {
            OptionCaption = ' ,Next of Kin,Nominee';
            OptionMembers = " ","Next of Kin",Nominee;
        }
    ...
    keys
    {
        key(Key1; "Account No", Name, "Next Of Kin Type")
        {
            Clustered = true;
        }
    }
