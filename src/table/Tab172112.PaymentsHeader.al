...
Table 172112 "Payments Header"
{
    ...
    fields
    {
        ...
        field(35; Status; Option)
        {
            ...
            Editable = true;
            OptionMembers = New,Pending,"1st Approval","2nd Approval","Cheque Printing",Posted,Cancelled,Checking,VoteBook,"Pending Approval",Approved;
            trigger OnValidate()
            begin
        ...
        {
            OptionCaption = 'Normal,Petty Cash,Tata,Payment Request';
            OptionMembers = Normal,"Petty Cash",Tata,"Payment Request";
        }
        ...
        field(67; "Pay Mode"; Option)
        {
            ...
            begin
                ...
                Rec.Reset;
                if Rec.Get("Pay Mode") then begin
                    if "Pay Mode" = "pay mode"::Mpesa then begin
                        Rec."Charge mpesa" := True;
                    end;
                End;
            End;
        ...
        field(104; "Payment Request"; Boolean)
        {

        }
        field(105; "Payment Requisition Form"; Code[100])
        {
            TableRelation = "Payments Header"."No." where("Payment Type" = filter("Payment Request"), Status = filter(Approved));
        }

        Field(106; "Charge mpesa"; Boolean) { }
    }
