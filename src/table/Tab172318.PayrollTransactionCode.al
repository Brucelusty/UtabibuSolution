...
Table 172318 "Payroll Transaction Code."
{
    //nownPage51516323;
    //nownPage51516323;
    ...
    fields
    {
        ...
        {
            OptionCaption = 'None,Shares,Loan,Loan Interest,Emergency Loan,Emergency Loan Interest,School Fees Loan,School Fees Loan Interest,Welfare,Pension,NSSF,Overtime,Holiday,Benevolent Fund';
            OptionMembers = "None",Shares,Loan,"Loan Interest","Emergency Loan","Emergency Loan Interest","School Fees Loan","School Fees Loan Interest",Welfare,Pension,NSSF,Overtime,Holiday,Special,"Benevolent Fund";
        }
        ...
        field(53; "Inclusive housing Leavy"; Boolean)
        {
