...
Table 172199 "HR Training Applications"
{
    ...
    fields
    {
        ...
        {
            NotBlank = true;
            TableRelation = "HR Training Needs".Code where(Closed = filter(false));
        ...
        field(45; "Training Group No."; Code[30])
        {
            ...
            trigger OnValidate()
            begin
                if HRTrainingApplicationsGroup.Get("Training Group No.") then begin
                    "Training group Name" := HRTrainingApplicationsGroup."Training Group Name";
                end;
            end;
        }
        ...
        field(48; "Training group Name"; Text[250])
        {
            Editable = false;
        }
    }
    ...
    var
        ...
        Vend: Record Vendor;
        HRTrainingApplicationsGroup: Record "HR Training Applications Group";
}
