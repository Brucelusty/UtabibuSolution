...
Table 172317 "Payroll Employee."
{
    ...
    fields
    {
        field(10; "No."; Code[20])
        {
            ...
            begin
                ...
                if HrEmployees.find('-') then begin
                    ...
                    "Employee Email" := HrEmployees."Company E-Mail";
                    ...
                    "Bank Name" := HrEmployees."Main Bank";
                    "Bank Code" := HrEmployees."Bank Code";
                    "Branch Code" := HrEmployees."Branch Code";
                    "Branch Name" := HrEmployees."Branch Bank";
                    "National ID No" := HrEmployees."ID Number";
                    Department := HrEmployees."Responsibility Center";
        ...
        field(128; "Hours worked 1.5"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(129; "Hours worked 2.0"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(130; "Rate 1.5"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(131; "Rate 2.0"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(132; "EmployeeUseriD"; Code[30])
        {
            FieldClass = FlowField;
            CalcFormula = lookup("HR Employees"."Employee UserID" where("No." = field("No.")));
            Editable = false;
        }
    }
    ...
    var
        ...
        PayrollProcessing: Codeunit "AU Payroll Processing";
