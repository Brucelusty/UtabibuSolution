Table 172183 "HR Leave Application" //172029
{
    ...
    fields
    {
        ...
        field(12; Status; Option)
        {
            ...
            var
                ...
                Message: Label 'Dear %1, Your Leave application of %2 day(s) starting on %3 and ending on %4 has been approved. You can proceed on your leave. Enjoy!!';
                EmailMessage2: Text;
                EMAIlCC2: list of [Text];
                BCC22: list of [Text];
                StaffEmail: list of [Text];
                Post: Record "HR Leave Application";
            begin


                if Status = Status::Approved then begin
                    StaffEmail.add("E-mail Address");
                    EMAIlCC2.Add('geofrey@utabibusacco.co.ke');
                    BCC22.Add('alex@utabibusacco.co.ke');
                    EmailMessage2 := StrSubstNo(Message, "Employee Name", "Approved days", "Start Date", "Return Date");
                    EmailMessage.Create(StaffEmail, 'Utabibu Sacco Leave Approval', EmailMessage2, true, EMAIlCC2, BCC22);
    ...
    var
        ...
        EmailBody: Label '<p>Your leave application no<strong> %2 </strong> has been approved you can proceed to you leave<p>';
    ...
    procedure NotifyApplicantApproved()
    var
        EmailTextBuilder: TextBuilder;
        Salutation: Label 'Dear %1';
        EmailBody: Label '<p>Your leave application no<strong> %2 </strong> has been approved you can proceed to you leave<p>';
    ...
    begin
        ...
        if ApprovalEntries.FindLast() then begin
            ...
            HREmp.Reset();
            HREmp.SetRange("Employee UserID", ApprovalEntries."Approver ID");
            if HREmp.Find('-') then begin
        ...
        FormatedBody := StrSubstNo(EmailTosend, HREmp."First Name" + ' ' + HREmp."Last Name", Rec."Application Code", Approvername + ' ' + companyInformation.Name);
