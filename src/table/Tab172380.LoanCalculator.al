    ...
    fields
    {
        ...
        field(10; "Requested Amount"; Decimal)
        {
            ...
            begin
                ...
                if ObjLoanType.Get("Loan Product Type") then begin
                    if "Requested Amount" > ObjLoanType."Max. Loan Amount" then begin
                        Error('Requested amount is more than the allowed limit of %1', ObjLoanType."Max. Loan Amount");
                    end;
                end;
                ...
                if ObjLoanType.Get("Loan Product Type") then begin
                    IF (ObjLoanType."Appraise Deposits") AND (ObjLoanType."Appraise Salary") THEN begin
                        ...
                        IF "Requested Amount" > "Eligible Amount" THEN begin
                            "Eligible Amount" := "Eligible Amount";
                        end ELSE begin
                            "Eligible Amount" := "Requested Amount";
                        end;
                    end;
        ...
        field(32; "Total Deduction"; Decimal)
        {
            ...
            begin
                ...
                "Qualification As Per Salary" := ("Basic Pay" - "Total Deduction" - "1/3rd") * Installments;
            end;
