...
Table 172552 "Change Request"
{
    ...
    fields
    {
        ...
        field(2; Type; Option)
        {
            OptionCaption = ' ,Mobile Change,ATM Change,Backoffice Change,Agile Change';
            OptionMembers = " ","Mobile Change","ATM Change","Backoffice Change","Agile Change";
            ...
            begin
                ...
                if Type = Type::"Backoffice Change" then begin
                    ...
                    if Memb.Find('-') then begin
                        ...
                        "Group Account No" := Memb."Group No";
                        "Member Account Status" := Memb.Status;
                        ...
                        Gender := Memb.Gender;
                        "Data Protection" := Memb."Data Protection";
        ...
        field(90; "Employer Code(New)"; Code[150])
        {
            DataClassification = ToBeClassified;
        ...
        {
            DataClassification = ToBeClassified;
            OptionCaption = 'Active,Awaiting Exit,Exited,Dormant,Deceased,Retired';
            OptionMembers = Active,"Awaiting Exit",Exited,Dormant,Deceased,Retired;
        }
        ...
        field(106; Gender; Enum "Employee Gender")
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(115; "Change Group Details"; Boolean)
        {

        }
        field(116; "Group Account No -New"; Code[30])
        {
            TableRelation = "Member Group".No;
        }
        field(117; "Data Protection"; boolean)
        {

        }
        field(118; "Data Protection(New)"; Boolean)
        {

        }
        field(119; "Deduct From Deposit"; Boolean)
        {
