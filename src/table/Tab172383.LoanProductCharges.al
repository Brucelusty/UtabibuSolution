...
Table 172383 "Loan Product Charges"
{
    ...
    fields
    {
        ...
        {
            OptionCaption = ' ,Loan Insurance,Loan Processing Fee,Loan Appraisal Fee,Loan Form Fees,Sms Fee';
            OptionMembers = " ","Loan Insurance","Loan Processing Fee","Loan Appraisal Fee","Loan Form Fees","Sms Fee";
        }
    }
