...
Table 172360 "Membership Applications"
{
    ...
    fields
    {
        ...
        field(68005; "E-Mail (Personal)"; Text[500])
        {
        ...
        {
            TableRelation = Wards.Ward where("SubCounty Code" = field(District));
        }
        ...
        field(68012; "ID No."; Code[30])
        {
            ...
            var
                ...
                TransferCustom: Codeunit "Transfer Custom Field";
            begin
                for i := 1 to StrLen("ID No.") do
                    TransferCustom.CheckForLetters("ID No.");
                // if Char.IsLetter("ID No."[i]) then
                //     FieldError("ID No.", PhoneNoCannotContainLettersErr);
                if (StrLen("ID No.") < 5) or (StrLen("ID No.") > 12) then
                    Error('ID No Can not be less than 5 Characters or more than 8 characters');
                if "ID No." <> '' then begin
                    Cust.Reset;
        ...
        field(68013; "Mobile Phone No"; Code[50])
        {
            ...
            begin
                ...
                for i := 1 to StrLen("Mobile Phone No") do
                    TransferCustom.CheckForLetters("Mobile Phone No");
                ...
                //     Error('Mobile No. Cannot be less than 12 Characters');

                if "Mobile Phone No" <> '' then begin
                    Cust.Reset;
                    Cust.SetRange(Cust."Mobile Phone No", "Mobile Phone No");
                    if Cust.Find('-') then
                        Error('This Mobile Number is already in use by an active Member.Kindly  use another number %1 Member No %1', Cust."Mobile Phone No", Cust."No.");
                end;
                ...
                if "Mobile Phone No" <> '' then begin
                    ...
                    if ObjMemberApplication.Find('-') = true then
                        Error('This Mobile Number %1 is already in use by application No %1.Kindly  use another number', ObjMemberApplication."Mobile Phone No", ObjMemberApplication."No.");
                end;
            end;
        }
        ...
        field(68017; Gender; Enum "Employee Gender")
        {
        ...
        field(68018; "Monthly Contribution"; Decimal)
        {
            ...
            begin
                ...
                if "Monthly Contribution" < GenSetUp."Min. Contribution" Then begin
                    error('Minimum Monthly contribution %1', GenSetUp."Min. Contribution");
                end
        ...
        field(68136; "KRA PIN"; Code[20])
        {
            trigger OnValidate()
            begin
                if StrLen("KRA PIN") <> 11 then begin
                    Error('The Length of Kra should be 11 digits');
                end;
            end;
        }
            ...
            begin
                ...
                */
                ...
                if CustMember.FindSet then begin
                    ...
                    "E-Mail (Personal)" := CustMember."E-Mail (Personal)";
        ...
        field(69120; "Secondary Mobile No"; Code[20])
        {
            ...
            begin
                ...
                for i := 1 to StrLen("Secondary Mobile No") do
                    TransferCustom.CheckForLetters("Secondary Mobile No");
                // if Char.IsLetter("Mobile Phone No"[i]) then
                //     FieldError("Mobile Phone No", PhoneNoCannotContainLettersErr);

                if (StrLen("Secondary Mobile No") <> 12) then
                    Error('Mobile No. Cannot be less than 10 Characters');
            end;
        }
        ...
        {
            DataClassification = ToBeClassified;
            OptionCaption = ' ,Checkoff,Standing Order,Others';
            OptionMembers = " ",Checkoff,"Standing Order",Others;
        }
        ...
        field(172000; "PassPort Exipiry Date"; Date)
        {

        }
        field(172001; "Member Category"; Enum "Member Category")
        {

        }
        field(172002; "Sub Category"; Enum PEPS)
        {

        }
        field(172003; "Source Of Income"; Option)
        {
            OptionMembers = " ",Salary,Business,Pension,Others;
            OptionCaption = ' ,Salary,Business,Pension,Others';
        }
        field(172004; Others; Text[2048])
        {

        }
        field(172005; "How did you Know About Us"; Option)
        {
            OptionCaption = ' ,Newspaper,Radio,Television Advert,Website,Facebook,Twitter,Another Member,Sales Representative,Staff,Parent,spouse,Others';
            OptionMembers = " ",Newspaper,Radio,"Television Advert",Website,Facebook,Twitter,"Another Member","Sales Representative",Staff,parent,spouse,Others;
        }
        field(172006; "Type of house"; Enum "Type of House")
        {

        }
        field(172007; "Access to Clean water"; Enum "True $ False")
        {

        }
        field(172008; "Monthly Income"; Enum "Monthly Income Range")
        {

        }
        field(172009; "HouseHold Size"; Enum Household)
        {

        }
        field(172010; "Group No"; Code[300])
        {
            DataClassification = ToBeClassified;
            TableRelation = "Member Group".No;
        }
        field(172011; "Minimum Share Capital"; Decimal)
        {

        }
        field(172012; "Access To Medical Cover"; Enum "True $ False")
        {

        }
        field(172013; "Group Members Snapshort"; MediaSet)
        {
            Caption = 'Group Members Snapshort';
        }
        field(172014; "Max Share Capital"; Decimal)
        {

        }
        field(172015; "Paid Registration Fee"; Boolean)
        {

        }

        field(172016; "Average Turn Over"; Decimal)
        {

        }
        field(172017; "County Name"; Text[250])
        {
            FieldClass = FlowField;
        ...
        field(172018; "Sub-County Name"; Text[2048])
        {
            FieldClass = FlowField;

            CalcFormula = lookup("Sub Counties"."Sub-County Name" where("Sub-County Code" = field(District)));
        }
        field(172019; "Data Protection"; Boolean)
        {

        }

        field(172020; "Programmed Deposits"; Decimal)
        {

        }
        field(172021; "Introducer Relationship"; Code[50])
        {
            TableRelation = "Relationship Types";
        }
        field(172022; "Deduct Registration Fee"; Boolean)
        {
