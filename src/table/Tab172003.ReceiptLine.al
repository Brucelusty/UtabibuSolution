...
Table 172003 "Receipt Line"
{
    ...
    fields
    {
        ...
        field(16; "Account Code"; Code[20])
        {
            ...
            if ("Account Type" = const(Customer)) Customer."No." where(ISNormalMember = filter(false))
            else
        ...
        {
            OptionCaption = ' ,Cash,Cheque,Deposit Slip,EFT,Bankers Cheque,RTGS,Mpesa';
            OptionMembers = " ",Cash,Cheque,"Deposit Slip",EFT,"Bankers Cheque",RTGS,Mpesa;
        }
