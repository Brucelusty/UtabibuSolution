...
Table 172376 "Loan Offset Details"
{
    ...
    fields
    {
        ...
        field(5; "Principle Top Up"; Decimal)
        {
            ...
            begin
                ...
                if Loans.Find('-') then begin
                    ...
                    loans.CalcFields(loans."Penalty Charged");
                ...
                //     Error('Amount cannot be greater than the loan oustanding balance.');
                NewLoan.Reset();
                NewLoan.SetRange("Loan  No.", "Loan No.");
                if NewLoan.Find('-') then begin
                    ...
                    if NewLoan."Loan Product Type" <> 'DEFAULT' then begin
                        ...
                        if Loantypes.Find('-') then begin
                            ...
                            Commision := (Loantypes."Loan Boosting Commission %" / 100) * ("Principle Top Up" + "Interest Top Up");
                        end;


                        "Total Top Up" := "Principle Top Up" + "Interest Top Up" + Commision + "Penalty Charged";
                    end;
                end;
            end;
        }
        ...
        field(30; "Total Commission"; Decimal)
        {
            FieldClass = FlowField;
    ...
    fieldgroups
    {
        fieldgroup(DropDown; "Client Code", "Loan Type", "Principle Top Up", "Interest Top Up", "Total Top Up", "Monthly Repayment", "Interest Paid", "Outstanding Balance", "Interest Rate", Commision, "Penalty Charged")
        {
        }
    }
    ...
    begin
        ...
        if ObjLoans.Get("Loan Top Up") then begin
            ...
            objloans.CalcFields(objloans."Penalty Charged");
            "Penalty Charged" := ObjLoans."Penalty Charged";
        end;
        ...
        Loans.Reset;
        Loans.SetRange(Loans."Loan  No.", "Loan Top Up");
        Loans.SetAutoCalcFields("Outstanding Balance", "Outstanding Interest", "Penalty Charged");
        if Loans.Find('-') then begin
            ...
            if Loantypes.Find('-') then begin
                if Loans."Loan Product Type" <> 'DEFAULT' then begin
                    Commision := Round((Loantypes."Loan Boosting Commission %" / 100) * (Loans."Outstanding Balance" + Loans."Outstanding Interest"), 1, '=');
                    //Message('commission %1', Commision);
            ...
            //  Message('jj-%1-%2-%3',Loans."Outstanding Balance",Loans."Outstanding Interest",Loans."Penalty Charged");
            "Principle Top Up" := Loans."Outstanding Balance";
            "Interest Top Up" := Loans."Outstanding Interest";
            "Penalty Charged" := Loans."Penalty Charged";
            "Loan Insurance: Current Year" := VarInsuranceAmount;
            "Tax On Comission" := Round(Commision * (GenSetUp."Excise Duty(%)" / 100), 1, '=');
            "Total Top Up" := "Principle Top Up" + "Interest Top Up" + "Penalty Charged" + Commision; //+ Commision//+ "Tax On Comission" + VarInsuranceAmount + "Penalty Charged";
        ...
        if Loans.Get("Loan No.") then begin
            if "Total Top Up" > Loans."Requested Amount" then
                Message('You Can not offset more than the requested loan amount of %1 - % Top up Amount%2', Loans."Requested Amount", "Total Top Up");
        end;
    end;
}
