...
Table 172209 "HR Job Applications"
{
    ...
    fields
    {
        ...
        field(82; "Field of Study"; Code[50])
        {
            DataClassification = CustomerContent;
            TableRelation = "Field of Study";
            Caption = 'Field of Study';
        }
        field(83; "Education Type"; Enum "Education Types")
        {
            DataClassification = CustomerContent;
            Caption = 'Education Type';
        }
        field(84; "Education Level"; Enum "Education Level")
        {
            DataClassification = CustomerContent;
            Caption = 'Education Level';
        }
        field(85; "Proficiency Level"; Enum "Proficiency Level")
        {
            DataClassification = CustomerContent;
            Caption = 'Proficiency Level';
        }
        field(86; "Minimum years of experience"; integer)
        {
            DataClassification = CustomerContent;
            Caption = 'Minimum years of experience';
        }
        field(87; "Maximum years of experience"; integer)
        {
            DataClassification = CustomerContent;
            Caption = 'Maximum years of experience';
        }
        field(88; "Experience industry"; Code[50])
        {
            DataClassification = CustomerContent;
            TableRelation = "Company Job Industry";
            Caption = 'Experience industry';
        }
        field(89; "Professional Course"; Code[50])
        {
            DataClassification = CustomerContent;
        ...
        field(90; "Professional Membership"; Code[50])
        {
            DataClassification = CustomerContent;
            TableRelation = "Professional Memberships";
            Caption = 'Professional Membership';
        }
        field(91; Notified; Boolean)
        {

        }
        field(92; "Select To Hire"; Boolean)
        {
            DataClassification = CustomerContent;
            Caption = 'Select To Hire';
        }
        field(93; Hired; Boolean)
        {
