...
Table 172970 "Daily Interest/Penalty Buffer"
{
    ...
    fields
    {
        ...
        field(172160; "Transaction Type"; Option)
        {
            OptionCaption = 'Penalty Charged,Interest Accrual';
            OptionMembers = "Penalty Charged","Interest Accrual";
        }
        field(172161; "Loan No"; Code[50])
        {
            TableRelation = "Loans Register"."Loan  No.";
        }
        field(172162; Posted; Boolean)
        {
        }
        field(172163; "Posted On"; Date)
        {
        }
        field(172164; "Member Name"; Code[100])
        {
        }
        field(172165; "Base Amount"; Decimal)
        {
        }
        field(172166; "Loan Product Code"; Code[50])
        {
