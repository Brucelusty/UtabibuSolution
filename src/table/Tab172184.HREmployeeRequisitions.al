...
Table 172184 "HR Employee Requisitions"
{
    //nownPage51516185;
    //nownPage51516185;
    ...
    fields
    {
        ...
        field(3971; "Education Type"; Enum "Education Types")
        {
            DataClassification = CustomerContent;
            Caption = 'Education Type';
        }
        field(3973; "Education Level"; Enum "Education Level")
        {
            DataClassification = CustomerContent;
            Caption = 'Education Level';
        }
        field(3972; "Proficiency Level"; Enum "Proficiency Level")
        {
            DataClassification = CustomerContent;
            Caption = 'Proficiency Level';
        }
        field(3974; "Minimum years of experience"; integer)
        {
            DataClassification = CustomerContent;
