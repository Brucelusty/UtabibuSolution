...
Table 172374 "Loan Collateral Details"
{
    ...
    fields
    {
        ...
        field(17; "Collateral Registe Doc"; Code[50])
        {
            ...
            begin
                if ObjCollateralReg.Get("Collateral Registe Doc") then begin
                    ...
                    "Market Value":=ObjCollateralReg."Asset Value";
        ...
        field(27; "Client Code"; code[20])
        {

        }
        field(28; "Loan Requested Amount"; Decimal)
        {
            CalcFormula = sum("Loans Register"."Requested Amount" where("Loan  No." = field("Loan No")));
            FieldClass = FlowField;
        }
    }
