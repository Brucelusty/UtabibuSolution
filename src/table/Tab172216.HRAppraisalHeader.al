...
Table 172216 "HR Appraisal Header"
{
   ...
   Recommendations:=HRAppraisalRatings.Recommendations;
        ...
        field(172000; "Responsibility Center"; Code[10])
        {
            Caption = 'Responsibility Center';
        }
        field(172011; "Contract Type"; Option)
        {
            OptionMembers = Permanent,"Temporary",Voluntary,Probation,Contract;
        }
        field(172014; "Appraisal Approval Status"; Option)
        {
            OptionMembers = "Pending Approval",Approved;
        }
        field(172015; "Supervisor UserID"; Code[50])
        {
            TableRelation = User."User Name";
        }
        field(172020; "Prev Appraisal Code"; Code[50])
        {
        }
        field(172021; "Agreed Goals 1"; Text[30])
        {
            Description = 'Agreed goals for the year ahead';
        }
        field(172022; "Responsibility/Duties Comment"; Text[100])
        {
            Caption = 'Responsibility/Duties Agreed Score';
            FieldClass = Normal;
        }
        field(172023; "Attendance&Punctuality Comment"; Text[30])
        {
            Caption = 'Attendance & Punctuality Agreed Score';
            FieldClass = Normal;
        }
        field(172024; "Communication Agreed Comment"; Text[30])
        {
            FieldClass = Normal;
        }
        field(172025; "Cooperation Agreed Comment"; Text[30])
        {
            FieldClass = Normal;
        }
        field(172026; "Customer Service Agr Comment"; Text[30])
        {
            FieldClass = Normal;
        }
        field(172027; "Initiative Agreed Comment"; Text[30])
        {
            FieldClass = Normal;
        }
        field(172028; "Quality Agreed Comment"; Text[30])
        {
            FieldClass = Normal;
        }
        field(172029; "Teamwork Agreed Comment"; Text[30])
        {
            FieldClass = Normal;
        }
        field(172030; "Sales Skills Agreed Comment"; Text[30])
        {
            FieldClass = Normal;
        }
        field(172031; "Leadership Agreed Comment"; Text[30])
        {
            FieldClass = Normal;
        }
        field(172032; "Performance Coaching Comment"; Text[30])
        {
            Caption = 'Performance Coaching Agreed Score';
            FieldClass = Normal;
        }
