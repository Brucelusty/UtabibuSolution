...
Table 172398 "Sacco General Set-Up"
{
    ...
    fields
    {
        ...
        field(256; "Staff Registration Fee Amount"; Decimal)
        {

        }
        field(257; "M-Pesa Charge(0-10K)"; Decimal)
        {

        }
        field(258; "M-Pesa Charge(>10K)"; Decimal)
        {

        }
        field(259; "Mpesa A/c"; Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "G/L Account"."No.";
        }
        field(260; "Withdrawal Fee %"; Decimal)
        {
        }
        field(261; "Loan Application Perion"; DateFormula)
        {

        }
        field(262; "Deposit Boosting Rate"; Decimal)
        {

        }
        field(263; "Deposit Boosting A/C"; Code[50])
        {
            TableRelation = "G/L Account"."No.";
        }
        field(264; "M-Pesa Charges PV"; Decimal)
        {

        }
        field(265; " EFT Charges PV"; Decimal)
        {

        }
        field(266; "RTGS Charges PV"; Decimal)
        {

        }
        field(267; "Dividend processing start date"; date) { }
        field(268; "Withholding Tax (%) on dividends"; decimal) { }//
        field(269; "Chama Savings Rate"; decimal) { }
