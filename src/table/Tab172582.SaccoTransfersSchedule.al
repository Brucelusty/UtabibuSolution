...
Table 172582 "Sacco Transfers Schedule"
{
    ...
    fields
    {
        ...
        field(2; "Destination Account No."; Code[20])
        {
            ...
            if ("Destination Account Type" = const(CUSTOMER)) Customer."No.";
        ...
        {
            TableRelation = if ("Destination Account Type" = filter(CUSTOMER)) "Loans Register"."Loan  No." where("Client Code" = field("Destination Account No."),"Outstanding Balance"= filter(>0))
            else
            if ("Destination Account Type" = filter(VENDOR)) "Loans Register"."Loan  No." where("Client Code" = field("Destination Account No."),"Outstanding Balance"= filter(>0));
        }
