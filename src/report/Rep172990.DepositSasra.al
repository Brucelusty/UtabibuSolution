report 172990 DepositSasra
{
    Caption = 'DepositSasra';
    RDLCLayout = 'Layouts/DepositSasra.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            RequestFilterFields = "No.", Status, "Registration Date", "Shares Retained", "Current Shares", "Global Dimension 2 Code", "Account Category";
            ...
            column(Sacco_Branch; "Sacco Branch") { }
            ...
            column(SelfGuaranteedAmount; SelfGuaranteedAmount) { }
            column(SelfGuaranteedLoanNo; SelfGuaranteedLoanNo) { }
            ...
            begin
                ...
                LoanGuarantee.Reset;
                LoanGuarantee.SetRange("Self Guarantee", true);
                LoanGuarantee.SetRange("Member No", Customer."No.");

                if LoanGuarantee.FindFirst then begin
                    SelfGuaranteedAmount := LoanGuarantee."Amont Guaranteed";
                    SelfGuaranteedLoanNo := LoanGuarantee."Loan No";
                end;
            end;
    ...
    var
        ...
        Datefilter: Text;
        Cstatus: Text;
        LoanGuarantee: Record "Loans Guarantee Details";
        SelfGuaranteedAmount: Decimal;
        SelfGuaranteedLoanNo: Code[20];
