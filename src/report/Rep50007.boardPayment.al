report 50007 "board Payment"
{
    Caption = 'board Payment';
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = 'Layouts/boardPayment.rdlc';
    dataset

    {
        dataitem(SaccoInformation; SaccoInformation)
        {
            ...
            dataitem(BoarbPaymentsLines; "Boarb Payments Lines")
            {
                column(Name; Name) { }
                column(Staff_Board; "Staff\Board") { }
                column(Board_No; "Board No") { }
                column(Amount_Paid; "Amount Paid") { }
                column(Net__Amount; "Net  Amount") { }
            }
