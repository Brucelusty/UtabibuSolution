...
Report 172970 "Bank Advise Schedule"															
{															
    ...
    {															
        ...
        {															
            ...
            {															
                ...
                column(FOSAAccount_LoantrunchDisburesment; "Loan trunch Disburesment"."Pay Account")															
                {															
                }															
                ...
                begin															
                    ...
                    if ObjLoanBatch.Get("Batch No") then begin															
                        if ObjLoanBatch."Mode Of Disbursement" = ObjLoanBatch."mode of disbursement"::"Bank Transfer" then															
