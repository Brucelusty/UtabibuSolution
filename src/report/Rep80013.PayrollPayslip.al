...
Report 80013 "Payroll Payslip."
{
    ...
    dataset
    {
        dataitem("Payroll Employee."; "Payroll Employee.")
        {
            ...
            begin
                EmployeeName := '';
                PayrollEmp.Reset();
                PayrollEmp.SetRange("No.", "Payroll Employee."."No.");
                if PayrollEmp.Find('-') then begin
                    EmployeeName := PayrollEmp.Surname + ' ' + PayrollEmp.Firstname + ' ' + PayrollEmp.Lastname;
    ...
    begin
        ...
        ;
        if UserSetup.Get(UserId) then begin
            if UserSetup."View Payslip" = false then Error('You dont have permissions for payroll, Contact your system administrator! ')
        end;
