//<---------------------------------------------------------------------->															
Report 50065 "Member Deposits Per Group"
{
    RDLCLayout = 'Layouts/MeberGroupReport.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            RequestFilterFields = "No.", Status, "Employer Code", "Payroll No", "Shares Retained", "Group No";
            DataItemTableView = where(ISNormalMember = filter(true), "Group No" = filter(<> ''));
            ...
            column(Referee_Mobile_Phone_No; "Referee Mobile Phone No") { }
            column(Referee_Name; "Referee Name") { }
            column(Current_Shares; "Current Shares") { }
            column(Group_No; "Group No") { }
            column(EntryNo; EntryNo)
            {
            }

            dataitem("Member Group"; "Member Group")
            {
                DataItemLink = No = field("Group No");
                column(No; No) { }
