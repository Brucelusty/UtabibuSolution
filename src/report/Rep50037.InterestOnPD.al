report 50037 "Interest On PD"
{
    ApplicationArea = All;
    Caption = 'Interest On Programmed Deposits Report';
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = 'Layouts/InterestOnPDReport.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            RequestFilterFields = "No.", Status, "Employer Code", "Payroll No", "Interest on PD";
            ...
            column(Interest_on_PD; "Interest on PD") { }
