...
Report 80022 "Liquidity Statement"
{
    ...
    dataset
    {
        dataitem(Company; "Company Information")
        {
            ...
            begin
                ...
                //Matured Liabilities														
                GLAccount.Reset;
                GLAccount.SetFilter(GLAccount.Liquidity, '%1', GLAccount.Liquidity::MaturedLaibilities);
                if GLAccount.FindSet then begin
                    repeat
                        GLEntry.Reset;
                        GLEntry.SetRange(GLEntry."G/L Account No.", GLAccount."No.");
                ...
                //LiabilitiesMaturingwithin91Days
                GLAccount.Reset;
                GLAccount.SetFilter(GLAccount.Liquidity, '%1', GLAccount.Liquidity::LiabilitiesMaturingwithin91Days);
                if GLAccount.FindSet then begin
                    repeat
                        GLEntry.Reset;
                        GLEntry.SetRange(GLEntry."G/L Account No.", GLAccount."No.");
                ...
                GLAccount.Reset;
                GLAccount.SetFilter(GLAccount.Liquidity, '%1', GLAccount.Liquidity::OverdraftsandMaturedLoans);
                if GLAccount.FindSet then begin
                    repeat
                        GLEntry.Reset;
                        GLEntry.SetRange(GLEntry."G/L Account No.", GLAccount."No.");
                        ...
                        if GLEntry.FindSet then begin
                            GLEntry.CalcSums(Amount);
                            OverdraftsandMatured += GLEntry.Amount * -1;
                        end;
                    until GLAccount.Next = 0;
                end;

                //TotalOtherliabilitiesNew
                GLAccount.Reset;
