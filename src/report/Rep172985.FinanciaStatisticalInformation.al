report 172985 FinanciaStatisticalInformation
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/FinancialStaticalInformation.rdlc';


    dataset
    {
        dataitem(SaccoInformation; SaccoInformation)
        {
            column(Code; Code) { }
            ...
            begin
                ...
                TotalRevenue := 0;
                GLAccount.Reset;
                GLAccount.SetFilter(GLAccount.StatementOfFP2, '%1', GLAccount.StatementOfFP2::Revenue);
                if GLAccount.FindSet then begin
                    repeat
                        GLEntry.Reset;
                        GLEntry.SetRange(GLEntry."G/L Account No.", GLAccount."No.");
