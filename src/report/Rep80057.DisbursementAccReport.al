report 80057 "Disbursement  Acc.Report"
{
    RDLCLayout = 'Layouts/DisbursmentReport.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            column(Disbursment_Account; "Disbursment Account") { }
            column(EntryNo; EntryNo)
            {
            }
            column(Registration_Fee_Paid; "Registration Fee Paid") { }
