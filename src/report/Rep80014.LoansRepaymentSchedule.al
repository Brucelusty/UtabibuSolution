...
Report 80014 "Loans Repayment Schedule"
{
            ...
            dataitem("Loan Repayment Schedule"; "Loan Repayment Schedule")
            {
                ...
                begin
                    ...
                    */
                    ...
                    if "Instalment No" = 1 then
                        LoanBalance := "Loan Repayment Schedule"."Loan Amount"
                    else
                        LoanBalance -= "Principal Repayment";


                    if "Loan Repayment Schedule"."Loan Balance" > 0 then
                        if "Loan Repayment Schedule"."Loan Balance" < "Monthly Repayment" then begin
                            "Principal Repayment" := "Loan Repayment Schedule"."Loan Balance";
                            "Monthly Repayment" := "Principal Repayment" + "Monthly Interest";
                        end;


                    "Monthly Repayment" := ROUND("Monthly Repayment", 1, '=');
                    "Principal Repayment" := ROUND("Principal Repayment", 1, '=');
                    "Monthly Interest" := ROUND("Monthly Interest", 1, '=');
                end;
