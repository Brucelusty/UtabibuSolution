...
Report 80015 "Loans Defaulter Aging - SASRA"
{
    ...
    dataset
    {
        dataitem("Loans Register"; "Loans Register")
        {
            ...
            begin
                ...
                IF "Loans Register"."Loan Reschedule" = true THEN begin
                    "Loans Register"."Loans Category" := "Loans Register"."Loans Category"::Perfoming;
                    "Loans Register"."Loans Category" := "Loans Register"."Loans Category-SASRA"::Perfoming;
                    "Loans Register".Rescheduled := true;
                    "0Month" := "Loans Register"."Outstanding Balance";
                end;

                IF ("Loans Register"."Mark As Performing" = True) THEN begin
                    "Loans Register"."Loans Category" := "Loans Register"."Loans Category"::Perfoming;
                    "Loans Register"."Loans Category" := "Loans Register"."Loans Category-SASRA"::Perfoming;
                    "0Month" := "Loans Register"."Outstanding Balance";
                ...
                IF ("Loans Register"."Loan Reschedule" = false) and ("Loans Register"."Mark As Performing" <> True) THEN begin
                    ...
                    if ("No.ofMonthsinArrears" = 0) then begin
                        ...
                        if "Loans Register"."Loan Product Type" = 'INSTANT' then begin
                            ...
                            if "Loans Register"."Loan Product Type" = 'DEFAULTER' then begin
                                "Loans Register"."Loans Category" := "Loans Register"."loans category"::Perfoming;
                                "Loans Register"."Loans Category" := "Loans Register"."Loans Category-SASRA"::Perfoming;
                                "0Month" := "Loans Register"."Outstanding Balance";
                                "Loans Register"."Amount in Arrears" := 0;
                                ...
                                if (("No.ofMonthsinArrears" > 0) and ("No.ofMonthsinArrears" <= 30)) then begin
                                    ...
                                    "Loans Register"."Loans Category" := "Loans Register"."Loans Category-SASRA"::Watch;
                                    ...
                                    if ("No.ofMonthsinArrears" > 30) and ("No.ofMonthsinArrears" <= 180) then begin
                                        ...
                                        "Loans Register"."Loans Category" := "Loans Register"."Loans Category-SASRA"::Substandard;
                                        ...
                                        if ("No.ofMonthsinArrears" > 180) and ("No.ofMonthsinArrears" <= 360) then begin
                                            ...
                                            "Loans Register"."Loans Category" := "Loans Register"."Loans Category-SASRA"::Doubtful;
                                            ...
                                            if ("No.ofMonthsinArrears" > 360) then begin
                                                ...
                                                "Loans Register"."Loans Category" := "Loans Register"."Loans Category-SASRA"::Loss;
