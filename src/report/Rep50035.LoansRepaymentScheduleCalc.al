//<---------------------------------------------------------------------->															
Report 50035 "Loans Repayment Schedule-Calc"
{
    ...
    dataset
    {
        dataitem("Loan Calculator"; "Loan Calculator")
        {
            ...
            column(Eligible_Amount; "Eligible Amount") { }
            column(Interestrate_LoanCalculator; "Loan Calculator"."Interest rate")
            {
            }
            column(RequestedAmount_LoanCalculator; "Loan Calculator"."Eligible Amount")
            {
            }
            ...
            dataitem("Loan Repay Schedule-Calc"; "Loan Repay Schedule-Calc")
            {
                ...
                column(LoanBalance; ROUND("Loan Repay Schedule-Calc"."Loan Balance", 1, '>'))
                {
                }
