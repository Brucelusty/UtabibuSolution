report 80053 "Disbursement Report"
{
    Caption = 'Disbursement Report';

    RDLCLayout = 'Layouts/DisbursementReport.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        ...
        {
            CalcFields = "Disbursment Account";
            PrintOnlyIfDetail = false;

            RequestFilterFields = "No.", Status, "Registration Date", "Shares Retained", "Disbursment Account", "Global Dimension 2 Code", "Account Category";
            ...
            column(Disbursment_Account_MembersRegister; Customer."Disbursment Account")
            {
            }
