report 50040 "Petty Cash"
{
    ApplicationArea = All;
    Caption = 'Petty Cash';
    UsageCategory = History;
    RDLCLayout = 'Layouts/PettyCash.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Payments Header"; "Payment Header.")
        {
            ...
            column(Payments_Header__Cheque_No__; "Payments Header"."No.")
            {
            }
            ...
            column(Bname; "Payments Header"."Bank Account Name")
            {
            }
            ...
            column(Bank; "Payments Header"."Bank Account")
            {
                IncludeCaption = true;
            }
            ...
            column(narrations; "Payments Header"."Payment Description")
            {
            }
            column(InvoiceNumber_PaymentsHeader; "Payments Header"."No.")
            {
            }
