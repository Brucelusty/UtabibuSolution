...
Report 80012 "Member Account Statement-dep"
{
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            {
                DataItemLink = "Customer No." = field("No."), "Posting Date" = field("Date Filter");
                //DataItemTableView = sorting("Posting Date") where("Transaction Type" = filter("Insurance Fee"));
                ...
                dataitem(loan; "Cust. Ledger Entry")
                {
                    ...
                    begin
						...
						*/
                        ...
                        // if loan."Transaction Type" = loan."transaction type"::"Insurance Fee" then begin
