report 50093 "Payment voucher Mpesa"
{

    RDLCLayout = 'Layouts/PaymentVoucherNew2.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Payments Header"; "Payments Header")
        {
            ...
            RequestFilterFields = "No.", Date, "Pay Mode";
            ...
            dataitem("Payment Line"; "Payment Line")
            {
                ...
                column(Payment_Line__Net_Amount__; "Payment Line"."Net Amount" - "Refund Charge")
                {
                ...
                column(RefundCharge; "Refund Charge")
                {
