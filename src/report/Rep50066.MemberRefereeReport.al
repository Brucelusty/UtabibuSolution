//<---------------------------------------------------------------------->															
Report 50066 "Member Referee Report"
{
    RDLCLayout = 'Layouts/MeberRefereeReport.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            DataItemTableView = where(ISNormalMember = filter(true), "Referee Member No" = filter(<> ''));
            ...
            column(Registration_Fee; Customer."Registration Fee Paid")
            {
            }
