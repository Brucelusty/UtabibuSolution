...
Report 80016 "CAPITAL ADEQUACY RETURN"
{
    ...
    dataset
    {
        dataitem(Company; "Company Information")
        {
            ...
            begin
                ...
                //Capital Grants
                GLAccount.Reset;
                GLAccount.SetFilter(GLAccount."Capital adequecy", '%1', GLAccount."capital adequecy"::CapitalGrants);
                if GLAccount.FindSet then begin
                    repeat
                        CapitalGrants := 0;
                        GLEntry.Reset;
                        ...
                        if GLEntry.FindSet then begin
                            GLEntry.CalcSums(Amount);
                            CapitalGrants += GLEntry.Amount * -1;
                        end;
                    until GLAccount.Next = 0;
                end;
                //retained earnings															
                ...
                if GLAccount.FindSet then begin
                    repeat
                        totalassetsPBSheet += GLAccount."Net Change";
                    until GLAccount.Next = 0;
                end;
                //OffBalanceSheet
                GLAccount.Reset;
                ...
                if GLAccount.FindSet then begin
                    repeat
                        OFFBALANCESHEETASSETS += GLAccount."Net Change";
                    until GLAccount.Next = 0;
                end;
