//************************************************************************
tableextension 172011 "PurchaseheaderEXT" extends "Purchase Header"
{
    fields
    {
        // Add changes to table fields here

        field(172000; Copied; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(172001; "Debit Note"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(172002; "Request for Quote No."; Code[20])
        {
            DataClassification = ToBeClassified;
        ...
        field(172003; "Quote Comments"; Text[150])
        {
            DataClassification = ToBeClassified;
            Description = 'Store Comments of Purchase Quote in the DB (Added)';
        }
        field(172004; "Responsibility Center Name"; Text[100])
        {
            DataClassification = ToBeClassified;
            Description = 'Stores Responsibilty Center Name in the database (Added)';
        }
        field(172005; "Donor Name"; Text[50])
        {
            DataClassification = ToBeClassified;
            Description = 'Stores Donor Name in the database (Added)';
        }
        field(172006; "Pillar Name"; Text[50])
        {
            DataClassification = ToBeClassified;
            Description = 'Stores Pillar Name in the database (Added)';
        }
        field(172009; "Quote Comments 2"; Text[80])
        {
            DataClassification = ToBeClassified;
        }
        field(172010; "Quote Comments 3"; Text[80])
        {
            DataClassification = ToBeClassified;
            Enabled = false;
        }
        field(172011; "Recommendation 1"; Text[80])
        {
            DataClassification = ToBeClassified;
        }
        field(172012; "Recommendation 2"; Text[80])
        {
            DataClassification = ToBeClassified;
        }
        field(172013; "Project Code"; Code[10])
        {
            DataClassification = ToBeClassified;
        }
        field(172014; "Archive Unused Doc"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(172050; "VAT Method"; Option)
        {
            DataClassification = ToBeClassified;
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = "Purchase Header"."No." where(Status = const(Released), "AU Form Type" = filter('Purchase Request'));
        ...
        field(172099; "AU Form Type"; Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = ',Imprest Accounting,Imprest Requisition,Payment Voucher,Receipt Voucher,Salary Advance,Funds Transfer,Petty Cash Voucher,Claim Voucher,Request Form,Travel Requsition Form,RFQ,Purchase Request,Purchase Quotes,Purchase Order,Purchase Invoice';
            OptionMembers = ,"Imprest Accounting","Imprest Requisition","Payment Voucher","Receipt Voucher","Salary Advance","Funds Transfer","Petty Cash Voucher","Claim Voucher","Request Form","Travel Requsition Form","RFQ","Purchase Request","Purchase Quotes","Purchase Order","Purchase Invoice";
        }
        field(172090; "RFQ No"; Code[100])
        {
            DataClassification = ToBeClassified;
