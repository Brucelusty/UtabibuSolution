//************************************************************************
tableextension 172007 "customertableEXT" extends Customer
{
    fields
    {
        ...
        field(53913; Gender; Enum "Employee Gender")
        {
            DataClassification = ToBeClassified;
        ...
        {
            Editable = true;
            OptionCaption = 'Active,Awaiting Exit,Exited,Dormant,Deceased,Withdrawn,Retired';
            OptionMembers = Active,"Awaiting Exit","Exited","Dormant","Deceased","Withdrawn","Retired";
        ...
        field(68019; "E-Mail (Personal)"; Text[500])
        {
        }
        ...
        {
            OptionCaption = ' ,Single,Married,Divorced,Wodow,Widower,Separated,';
            OptionMembers = " ",Single,Married,Divorced,Widow,Widower,Separated;
        }
        ...
        field(68049; "Dividend Amount"; Decimal)
        {
            CalcFormula = - sum("Detailed Cust. Ledg. Entry".Amount where("Customer No." = field("No."),
                                                                   ...
                                                                   "Posting Date" = field("Date Filter"),
                                                                   "Document No." = field("Document No. Filter"), "Entry Type" = filter(<> 'Application'), Reversed = filter(false)));
            FieldClass = FlowField;
        }
        ...
        field(68057; "Un-allocated Funds"; Decimal)
        {
            ...
            FieldClass = FlowField;
            CalcFormula = sum("Detailed Cust. Ledg. Entry".Amount where("Customer No." = field("No."),
                                                                   "Transaction Type" = const("Unallocated Fund"),
                                                                   "Posting Date" = field("Date Filter"),
                                                                   "Document No." = field("Document No. Filter")));
        ...
        field(68100; "Bank Account No."; Code[215])
        {
        }
        field(68101; "Bank Code"; Code[210])
        {
        ...
        field(68195; "Disbursment Account"; Decimal)
        {
            CalcFormula = - sum("Detailed Cust. Ledg. Entry".Amount where("Customer No." = field("No."),
                                                                  "Transaction Type" = filter("Disbursment Account"),
                                                                  "Posting Date" = field("Date Filter")));
            FieldClass = FlowField;
            Editable = false;
        }
        ...
        field(69095; "Name of the Group/Corporate"; Text[150])
        {
        }
        ...
        field(69114; "E-Mail (Personal3)"; Text[500])
        {
            Enabled = false;
        }
        ...
        field(69135; "E-Mail (Personal2)"; Text[500])
        {
        }
        ...
        field(69188; "Identification Document"; Option)
        {
            ...
            OptionMembers = "Nation ID Card","Passport Card","Aliens Cdividendcurrentard","Birth Certificate","Company Reg. No","Driving License";
        }
        ...
        {
            OptionCaption = ' ,Relocation,Loss of Employment,Financial Constraints,Retirement,Join another Institution,Personal Reasons,Other';
            OptionMembers = " ",Relocation,"Loss of Employment","Financial Constraints","Retirement","Join another Institution","Personal Reasons",Other;
        }
        ...
        field(69204; "Created By"; Code[40])
        {
        }
        ...
        field(69278; "Bank Name"; Text[250])
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(69281; "Bank Branch Name"; Text[230])
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(172000; "Old Account No"; Integer)
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
        ...
        field(172002; "Programmed Deposits"; Decimal)
        {
            CalcFormula = - sum("Detailed Cust. Ledg. Entry".Amount where("Customer No." = field("No."),
                                                                  "Transaction Type" = filter("Programmed Deposits"), "Posting Date" = field("Date Filter")
                                                                  ));
            FieldClass = FlowField;
        }
        field(172003; "Defaulted Loan Recovery"; Decimal)
        {
            CalcFormula = - sum("Detailed Cust. Ledg. Entry".Amount where("Customer No." = field("No."),
                                                                   "Transaction Type" = filter("Defaulted Loan Recovery"), "Posting Date" = field("Date Filter")
                                                                  ));
            FieldClass = FlowField;
        }
        ...
        field(172005; "Interest On Deposits"; Decimal)
        {
            CalcFormula = - sum("Detailed Cust. Ledg. Entry".Amount where("Customer No." = field("No."),
                                                                  ...
                                                                  , "Entry Type" = filter(<> 'Application'), Reversed = filter(false)));
            FieldClass = FlowField;
        }
        ...
        field(172012; "PassPort Exipiry Date"; Date)
        {

        }
        field(172013; MemberCategory; Enum "Member Category")
        {

        }
        field(172014; "Sub Category"; Enum PEPS)
        {

        }
        field(172015; "Source Of Income"; Option)
        {
            OptionMembers = " ",Salary,Business,Pension,Others;
            OptionCaption = ' ,Salary,Business,Pension,Others';
        }
        field(172016; Others; Text[2048])
        {

        }
        field(172017; "How did you Know about Us"; Option)
        {
        ...
        field(172018; "Type of house"; Enum "Type of House")
        {

        }
        field(172019; "Access to Clean water"; Enum "True $ False")
        {

        }
        field(172020; "Monthly Income"; Enum "Monthly Income Range")
        {

        }
        field(172021; "HouseHold Size"; Enum Household)
        {

        }
        field(172022; "Group No"; Code[300])
        {
            DataClassification = ToBeClassified;
        }
        field(172023; "Minimum Share Capital"; Decimal)
        {
        }
        field(172024; "Access To Medical Cover"; Enum "True $ False")
        {
        }

        field(172025; "Loan Count"; Integer)
        {
            FieldClass = FlowField;
            CalcFormula = count("Loans Register" where("Client Code"
            = field("No."), "Outstanding Balance" = filter(> 0)));
            Editable = false;
        }
        field(172026; "Loan Count taken"; Integer)
        {
            FieldClass = FlowField;
            CalcFormula = count("Loans Register" where("Client Code"
            = field("No."), Posted = filter(true)));
            Editable = false;
        }
        field(172027; "Group Members Snapshort"; MediaSet)
        {
            Caption = 'Group Members Snapshort';
        }
        field(172030; "Fosa PostFix"; Code[30])
        {

        }
        field(172031; "Max Share Capital"; Decimal)
        {

        }
        field(172032; "Paid Registration Fee"; Boolean)
        {

        }
        field(172033; "Average Turn Over"; Decimal)
        {
        }
        field(172034; "Interest Charged"; Decimal)
        {
            CalcFormula = sum("Interest Buffer Table"."Interest Amount" where("Member No" = field("No.")));
            FieldClass = FlowField;
        }
        field(172035; "County Name"; Text[250])
        {
            FieldClass = FlowField;

            CalcFormula = lookup(Counties."County Name" where("County Code" = field(County)));

        }
        field(172036; "Sub-County Name"; Text[2048])
        {
            FieldClass = FlowField;

            CalcFormula = lookup("Sub Counties"."Sub-County Name" where("County Code" = field(District)));

        }
        field(172037; "Data Protection"; Boolean)
        {

        }
        Field(172038; "BlackListed"; Option)

        {
            OptionMembers = " ",No,Yes;
            OptionCaption = ' ,False,True';
        }
        field(172039; "Interest on PD"; Decimal)

        {
            CalcFormula = - sum("Detailed Cust. Ledg. Entry".Amount where("Customer No." = field("No."),
                                                                            "Transaction Type" = filter("Interest on Programmed Deposits"),
                                                                  "Posting Date" = field("Date Filter")));
            FieldClass = FlowField;
            Caption = 'Interest on Programmed Deposits';
        }
        field(172040; "Dividend Loan Balance"; Decimal)
        {
            CalcFormula = sum("Detailed Cust. Ledg. Entry".Amount where("Customer No." = field("No."),
                                                                   "Transaction Type" = filter(Loan | repayment), "Loan Type" = filter('DIVIDEND'),
                                                                   "Posting Date" = field("Date Filter")));
            Editable = false;
            FieldClass = FlowField;
        }
        field(172041; "Loan Status"; Option)
        {
            OptionMembers = Active,Defaulter;
            Editable = false;
        }

        field(172042; "Programmed Deposit Contr."; Decimal)
        {
            Editable = False;
        }
        field(172043; "Introducer Relationship"; Code[50])
        {
            TableRelation = "Relationship Types";
        }
        field(172044; "Exempt 3 Months Policy"; Boolean)
        {

        }
        field(172045; "Exempted By"; Code[20])
        {
            Editable = false;
        }
        field(172046; "Standing Order Acount"; Decimal)
        {
            CalcFormula = - sum("Detailed Cust. Ledg. Entry".Amount where("Customer No." = field("No."),
                                                                   "Transaction Type" = const("Standing Order Account"),
                                                                   "Posting Date" = field("Date Filter"),
                                                                   "Document No." = field("Document No. Filter")));
            Editable = false;
            FieldClass = FlowField;
        }
        field(172047; "M-Wallet Account"; Decimal)
        {
            CalcFormula = - sum("Detailed Cust. Ledg. Entry".Amount where("Customer No." = field("No."),
                                                                   "Transaction Type" = filter("M-Wallet A/c"),
                                                                   "Posting Date" = field("Date Filter")));
            Editable = false;
            FieldClass = FlowField;
        }
        field(172048; "Partial Disbursement"; Decimal)
        {
            CalcFormula = - sum("Detailed Cust. Ledg. Entry".Amount where("Customer No." = field("No."),
        ...
        field(172049; "Exempted From Tax"; Boolean)
        {

        }
        field(172050; "Why Exempt from Tax?"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(172051; "Utapesa Credit limit"; Decimal)
        {

            FieldClass = FlowField;
            CalcFormula = lookup("Credit limit logs"."Current limit" where("Member No" = field("No.")));
        }
        field(172052; " Deduct Registration Fee"; Boolean)
        {
        }

        field(172053; "Special Accounts"; Boolean) { }

        field(172054; "Agm Present"; Boolean) { }
    }
    keys
    {
    ...
    fieldgroups
    {
        addlast(DropDown; "Name of the Group/Corporate", "ID No.", Name, ISNormalMember, "Payroll No")
        {
    ...
    procedure CalculateAge(ReferenceDate: Date): Text
    var
        Years: Integer;
        Months: Integer;
        Days: Integer;
    ...
    begin
        ...
        DOB := "Date of Birth";
        Years := Date2DMY(ReferenceDate, 3) - Date2DMY(DOB, 3);
        Months := Date2DMY(ReferenceDate, 2) - Date2DMY(DOB, 2);
        Days := Date2DMY(ReferenceDate, 1) - Date2DMY(DOB, 1);

        if Days < 0 then begin
            Months -= 1;
            Days += CalcDate('<1M>', DOB) - DOB;
        end;
        ...
        exit(StrSubstNo('%1 Years, %2 Months', Years, Months));
    end;
    ...
    var
        ...
        SalesPrice: Record "Price Calculation Buffer";
