//************************************************************************
tableextension 172049 "DetlCustLedgerExt" extends "Detailed Cust. Ledg. Entry"
{
    fields
    {
    ...
    keys
    {
        key(Key18; "Loan No", "Transaction Type")
        {
