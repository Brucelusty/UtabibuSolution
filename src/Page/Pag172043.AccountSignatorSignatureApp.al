...
Page 172043 "Account Signator Signature-App"
{
    PageType = CardPart;
        ...
        area(processing)
        {
            ...
            action(ExportFile)
            {
                ...
                begin
                    ...
                    // ExportPath := TemporaryPath + Rec."Document No" + Format(Rec.Signature.MediaId);
                    // Rec.Signature.ExportFile(ExportPath);
                    // FileManagement.GetServerDirectoryFilesList(TempNameValueBuffer, TemporaryPath);
                    // TempNameValueBuffer.SetFilter(Name, StrSubstNo('%1*', ExportPath));
                    // TempNameValueBuffer.FindFirst;
                    // ToFile := StrSubstNo('%1 %2.jpg', Rec."Document No", ConvertStr(Rec."Document No", '"/\', '___'));
