...
Page 50060 "Posted Loan Recovery Header"

{
    ...
    begin
        if LoansRec.Get(Rec."Loan to Attach") then begin
            ...
            GenJournalLine."account type"::None, LoansRec."Client Code", Rec."Loan Disbursement Date", TDefaulterLoan * -1, Format(LoanApps.Source), EXTERNAL_DOC_NO,
            ...
            if LoanApp.Find('-') then begin
                repeat
                    if RunningBalance > 0 then begin
                        ...
                        GenJournalLine."account type"::None, LoanApp."Client Code", Rec."Loan Disbursement Date", AmountToDeduct * -1, Format(LoanApp.Source), EXTERNAL_DOC_NO,
                ...
                GenJournalLine."account type"::None, Rec."Member No", Rec."Loan Disbursement Date", Rec."Total Interest Due Recovered", 'BOSA', EXTERNAL_DOC_NO,
    ...
    begin
        begin
            if LoansRec.Get(Rec."Loan to Attach") then begin
                ...
                LineNo := LineNo + 10000;
                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::Repayment,
                GenJournalLine."account type"::None, LoansRec."Client Code", Rec."Loan Disbursement Date", Rec."Deposits Aportioned" * -1, Format(LoansRec.Source), EXTERNAL_DOC_NO,
                Format(GenJournalLine."transaction type"::Repayment), Rec."Loan to Attach", GenJournalLine."application source"::" ");
                //--------------------RECOVER-----------------------------
                LineNo := LineNo + 10000;
                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"Deposit Contribution",
                GenJournalLine."account type"::None, Rec."Member No", Rec."Loan Disbursement Date", Rec."Deposits Aportioned", Format(LoansRec.Source), EXTERNAL_DOC_NO,
    ...
    begin
        if RunningBalance > 0 then begin
            ...
            if LoanApp.Find('-') then begin
                ...
                LineNo := LineNo + 10000;
                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::Repayment,
                GenJournalLine."account type"::None, LoanApp."Client Code", Rec."Loan Disbursement Date", Rec."Mobile Loan" * -1, 'FOSA', EXTERNAL_DOC_NO,
                Format(GenJournalLine."transaction type"::Repayment), LoanApp."Loan  No.", GenJournalLine."application source"::" ");
                //--------------------RECOVER-----------------------------
                LineNo := LineNo + 10000;
                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"Deposit Contribution",
                GenJournalLine."account type"::None, Rec."Member No", Rec."Loan Disbursement Date", Rec."Mobile Loan", 'BOSA', EXTERNAL_DOC_NO,
    ...
    begin
        if RunningBalance > 0 then begin
            ...
            if LoanApp.Find('-') then begin
                ...
                LineNo := LineNo + 10000;
                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"Deposit Contribution",
                GenJournalLine."account type"::None, Rec."Member No", Rec."Loan Disbursement Date", Rec."Total Thirdparty Loans", 'BOSA', EXTERNAL_DOC_NO,
                Format(GenJournalLine."transaction type"::"Deposit Contribution") + '-' + LoanApp."Loan Product Type", '', GenJournalLine."application source"::" ");
            end;
            exit(RunningBalance);
        end;
    ...
    begin
        ...
        if LoanDetails.FindSet then begin
            repeat
                ...
                GenJournalLine."account type"::None, LoanDetails."Guarantor Number", Rec."Loan Disbursement Date", LoanDetails."Defaulter Loan", Format(LoansRec.Source::BOSA), Rec."Loan to Attach",
