...
Page 50037 "Agent/NOK/Sign. Change Card"
{
    PageType = Card;
            ...
            group(General)
            {
                ...
                field("Change Type"; Rec."Change Type")
                {
                    ...
                    begin
                        ...
                        IF (Rec."Change Type" = Rec."Change Type"::"Account Next Of Kin Change") AND (Rec."Account Type" = Rec."Account Type"::BOSA) THEN BEGIN
                            VarAccountAgentVisible := FALSE;
                            VarFOSANOKVisible := FALSE;
                            VarBOSANOKVisible := TRUE;
                        END;

                        IF (Rec."Change Type" = Rec."Change Type"::"Account Agent Change") AND (Rec."Account Type" = Rec."Account Type"::FOSA) THEN BEGIN
        ...
        area(creation)
        {
            ...
            action(Approval)
            {
                ...
                begin
                    ...
                    ApprovalEntries.SetRecordFilters(Database::"Member Agent/Next Of Kin Chang", DoctypeEnum, rec."Document No");
                    ApprovalEntries.Run;
                end;
            }
        }
        ...
        if ObjNOKAgentChange.FindSet then begin
            ...
            if ObjMemberNextofKinChange.FindSet then begin
                repeat
                    ...
                    ObjMemberNOKDetails.Relationship := ObjMemberNextofKinChange.Relationship;
