page 172850 Saccoinformation
{
    ApplicationArea = All;
    Caption = 'Sacco Information';
    PageType = Card;
    Editable = true;
    SourceTable = SaccoInformation;
    InsertAllowed = false;
    DeleteAllowed = false;
    ...
    layout
    {
        area(content)
        {
            ...
            {
                part("Board of Directors Lists"; boardofdirectorslist)
                {
                    ApplicationArea = all;
                }
            }
            ...
            {
                part("Supervisory Commitee Lists"; supervisorycommiteelist)
                {
                    ApplicationArea = all;
                }
            }
