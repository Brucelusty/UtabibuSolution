            ...
            group("Request Approval")
            {
                ...
                action(SendApprovalRequest)
                {
                    ...
                    begin
                        ...
                        if workflowIntergration.CheckHREmployeeRequisitionApprovalsWorkflowEnabled(Rec) then
                            workflowIntergration.OnSendHREmployeeRequisitionApplicationForApproval(Rec);
