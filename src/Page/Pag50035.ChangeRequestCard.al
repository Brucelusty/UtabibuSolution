...
Page 50035 "Change Request Card"
{
    PageType = Card;
    DeleteAllowed = false;
                    ...
                    if rec.Type = rec.Type::"Backoffice Change" then begin
                        ...
                        if Memb.Find('-') then begin
                            ...
                            if rec."Mobile No(New Value)" <> '' then begin
                                ...
                                mobileapplications.SetRange("Account No", memb."No.");
                                if mobileapplications.FindFirst() then begin
                                    repeat
                                        mobileapplications.Telephone := Rec."Mobile No(New Value)";
                                        mobileapplications.modify(true);
                            ...
                            if Rec.signinature.Count <> 0 then begin
