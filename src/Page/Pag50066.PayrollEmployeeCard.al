...
Page 50066 "Payroll Employee Card."
{
    DeleteAllowed = false;
    InsertAllowed = true;
    PageType = Card;
    SourceTable = "Payroll Employee.";
    PromotedActionCategories = 'New,Process,Report,Process Payroll,Payslip,Earnings and Deductions';
    ...
    layout
    {
        area(content)
        {
            ...
            group("Pay Details")
            {
                ...
                field("Hours worked 2.0"; Rec."Hours worked 2.0")
                {

                }
                field("Rate 2.0"; Rec."Rate 2.0")
                {

                }
                field("Hours worked 1.5"; Rec."Hours worked 1.5")
                {

                }
                field("Rate 1.5"; Rec."Rate 1.5")
                {
