...
Page 50067 "Payroll Employee List."
{
                        ...
                        repeat
                            ...
                            if SalCard.Get(HrEmployee."No.") then
                                if not SalCard."Suspend Pay" then begin
                                    ...
                                    HrEmployee."Date of Leaving", true, HrEmployee."Branch Code", PayrollCode, false);
                                    //strEmpCode: Code[20]; dtDOE: Date; curBasicPay: Decimal; blnPaysPaye: Boolean; blnPaysNssf: Boolean; blnPaysNhif: Boolean; SelectedPeriod: Date; dtOpenPeriod: Date; Membership: Text[30]; ReferenceNo: Text[30]; dtTermination: Date; blnGetsPAYERelief: Boolean; Dept: Code[20]; PayrollCode: Code[20]; SuspendPay: boolean
