...
Page 17240 "Loan Application Card(FOSA)"
{
    DeleteAllowed = false;
    InsertAllowed = true;
    PageType = Card;
        ...
        area(content)
        {
            group(General)
            {
                ...
                group("Tranch Details")
                {
                    ...
                    field("Amount to Disburse on Trunch 1"; Rec."Amount to Disburse on Trunch 1")
                    {
                        ApplicationArea = Basic;
                    }
                    field("No of Trunch Disbursment"; Rec."No of Tranch Disbursment")
                    {
                        ApplicationArea = Basic;
                    }
                }
