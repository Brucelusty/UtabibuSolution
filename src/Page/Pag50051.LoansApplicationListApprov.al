...
Page 50051 "Loans Application List(Approv)"
{
    ...
    begin
        ...
        */
        ...
        GenJournalLine."account type"::None, LoanApps."Client Code", Rec."Posting Date", LoanApps."Approved Amount", 'BOSA', LoanApps."Loan  No.",
        ...
        if LoanApps."Boost this Loan" then begin
            ...
            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::Loan,
            GenJournalLine."account type"::None, LoanApps."Client Code", Rec."Posting Date", LoanApps."Boosted Amount", 'BOSA', BLoan,
            ...
            GenJournalLine."account type"::None, Rec."Client Code", Rec."Posting Date", LoanApps."Boosted Amount" * -1, 'BOSA', BLoan,
        ...
        if LoanApps."Boosting Commision" > 0 then begin
            ...
            LineNo := LineNo + 10000;
            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"Interest Paid",
            GenJournalLine."account type"::None, Rec."Client Code", Rec."Posting Date", LoanApps."Boosted Amount Interest" * -1, 'BOSA', BLoan,
