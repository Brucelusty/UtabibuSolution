...
Page 17324 "Membership Appl. - Created"
{
    ...
    SourceTableView = where(Created = filter(true));
    ...
    layout
    {
        area(content)
        {
            repeater(Control1102755000)
            {
                ...
                field("Registration fee"; RegFeePaid) { Visible = false; }

                field("Monthly Contribution"; Rec."Monthly Contribution")
                {
                    ApplicationArea = Basic;
                }
                field("Current Deposits"; currentshares)
                {
                    ApplicationArea = Basic;
                    Visible = false;
                }
                        ...
                        if Confirm('Are you sure you want to create account application?', false) = true then begin
                            ...
                            if ObjProductsApp.FindSet then begin
                                repeat
                                 ...
                                 //   ObjCust." Deduct Registration Fee":=Rec."Deduct Registration Fee";
    ...
    begin
        ...
        if cust2.Get(Rec."No.") then
            RegFeePaid := cust2."Registration Fee Paid";
        currentshares := cust2."Current Shares";
    end;
}
