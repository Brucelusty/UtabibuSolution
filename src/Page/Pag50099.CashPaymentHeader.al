...
Page 50099 "Cash Payment Header"
{
            ...
            group("&Functions")
            {
                ...
                action("Post Payment")
                {
                    ...
                    begin
                        ...
                        if Confirm('Are you sure you want to post this payment?') = false then
                            exit;
                ...
                action(Approvals)
                {
                    ...
                    begin
                        ...
                        ApprovalEntries.SetRecordFilters(Database::"Payment Header.", DocumentType, rec."No.");
                        ApprovalEntries.Run;
                ...
                action("Print/Preview")
                {
                    ...
                    begin
                        ...
                        if rec.FindFirst() then
                            Report.RunModal(50040, true, true, Rec)
