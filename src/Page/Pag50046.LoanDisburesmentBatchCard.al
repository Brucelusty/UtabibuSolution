...
Page 50046 "Loan Disburesment Batch Card"
{
    DeleteAllowed = false;
    PageType = Card;
                    ...
                    begin
                        ...
                        if LoanApps.Find('-') then begin
                            repeat
                                ...
                                DetailedLedger.setrange("Loan No", LoanApps."Loan  No.");
                                if DetailedLedger.FindFirst() then begin
                                    error('Loan Already Posted %1', LoanApps."Loan  No.");
                                end;
                                if LoanApps."View Schedule" = false then Error('Generate Schedule for this Loan before posting');
                                if (LoanApps."Mode of Disbursement" <> LoanApps."mode of disbursement"::"FOSA Account") then begin
                                    ...
                                    FnDisburseToBankAccount(LoanApps, LoanApps."Loan  No.");//createPosting
    ...
    begin
        ...
        IF LoanApps.GET(VarLoanNo) THEN BEGIN
            ...
            if LoanApps."Mode Of Disbursement" = LoanApps."Mode Of Disbursement"::EFT then begin
                ...
                LineNo := LineNo + 10000;
                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."Transaction Type"::" ",
                GenJournalLine."Account Type"::"G/L Account", GenSetUp."Loan Trasfer Fee A/C-EFT", rec."Posting Date", EFTAmount * -1, 'BOSA', LoanApps."Loan  No.",
            ...
            if LoanApps."Mode Of Disbursement" = LoanApps."Mode Of Disbursement"::RTGS then begin
                ...
                LineNo := LineNo + 10000;
                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."Transaction Type"::" ",
                GenJournalLine."Account Type"::"G/L Account", GenSetUp."Loan Trasfer Fee A/C-RTGS", rec."Posting Date", RTGSAmount * -1, 'BOSA', LoanApps."Loan  No.",
            ...
            if LoanApps."Mode Of Disbursement" = LoanApps."Mode Of Disbursement"::Mpesa then begin
                ...
                LineNo := LineNo + 10000;
                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."Transaction Type"::" ",
                GenJournalLine."Account Type"::"G/L Account", GenSetUp."Mpesa A/c", rec."Posting Date", MpesaChargeAmount * -1, 'BOSA', LoanApps."Loan  No.",
            ...
            LineNo := LineNo + 10000;
            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."Transaction Type"::" ",
            GenJournalLine."Account Type"::"Bank Account", LoanApps."Paying Bank Account No", rec."Posting Date", (LoanApps."Loan Disbursed Amount") * -1, 'BOSA', LoanApps."Batch No.",
