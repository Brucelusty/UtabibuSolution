...
Page 17300 "Loan Demand Notices Card"
{
    PageType = Card;
                ...
                action("CRB Demand Letter")
                {
                    ...
                    begin
                        ...
                        if ObjLoans.FindSet then begin
                            Report.run(50061, true, true, ObjLoans);
                        end;
                    end;
                }
                action("Debt Collector Demand Letter")
                {
                    ...
                    begin
                        ...
                        if ObjDemands.FindSet then begin
                            Report.run(50060, true, true, ObjDemands);
                        end;
                    end;
                }
            ...
            group(Approvals)
            {
                ...
                action(Approval)
                {
                    ...
                    begin
                        ...
                        ApprovalEntries.SetRecordFilters(Database::"Default Notices Register", DocumentType, Rec."Document No");
                        ApprovalEntries.Run;
                    end;
                }
