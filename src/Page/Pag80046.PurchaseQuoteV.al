page 80046 "Purchase QuoteV"
{
                        ...
                        if PurchaseHeader.FindFirst() then begin
                            ...
                            if PurchaseLine.Find('-') then begin
                                repeat
                                    ...
                                    if NewPurchaseline.FindLast() then begin
                                    ...
                                    //Message('jatelo%1', NewPurchaseline."Unit of Measure");
            ...
            group("F&unctions")
            {
                ...
                action(CopyDocument)
                {
                    ...
                    begin
                        ...
                        PurchaseLine.Reset();
                        PurchaseLine.SetRange("Document No.", Rec."No.");
                        if PurchaseLine.Find('-') = true then begin
                            Message('ho');
                            PurchaseLine.DeleteAll();
                        end;
                        rec.CopyDocument();
    ...
    begin
        ...
        Rec."No." := NoSeriesManagement.GetNextNo(PurchasesPayablesSetup."Tender Request No", Today, true);
        usersetup3.Reset();
