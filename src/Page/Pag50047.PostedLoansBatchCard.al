...
Page 50047 "Posted Loans Batch Card"
{
    DeleteAllowed = false;
    Editable = false;
    InsertAllowed = false;
                ...
                action("Post ")
                {
                    ...
                    begin
                        ...
                        if LoanApps.Find('-') then begin
                            repeat
                                ...
                                if (LoanApps.Source = LoanApps.Source::BOSA) and
                                   (rec."Mode Of Disbursement" <> rec."mode of disbursement"::"FOSA Account") then
                                ...
                                if PCharges.Find('-') then begin
                                    repeat
                                        ...
                                        if (rec."Mode Of Disbursement" = rec."mode of disbursement"::"FOSA Account") or
                                           (rec."Mode Of Disbursement" = rec."mode of disbursement"::"FOSA Account") then begin
                        ...
                        if rec."Mode Of Disbursement" = rec."mode of disbursement"::"Bank Transfer" then begin
                            //No Cheque for STIMA
                            //("Mode Of Disbursement"="Mode Of Disbursement"::"FOSA Account") THEN BEGIN
                            LineNo := LineNo + 10000;
