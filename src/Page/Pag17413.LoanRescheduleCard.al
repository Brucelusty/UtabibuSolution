...
Page 17413 "Loan Reschedule Card"
{
    PageType = Card;
                    ...
                    begin
                        if Confirm('Are you sure you want to reshedule the loan') then begin
                            ...
                            if LoanRegister.Find('-') then begin
                                Report.Run(Report::"Loans Repayment Schedule", true, false, LoanRegister);
                            end;
                        ...
                        GenJournalLine."account type"::Member, Rec."Member No", Rec."Rescheduled Date", (Rec."Outstanding Loan Amount" * SaccoGeneralSetUp."Reschedule Charge(%)" / 100), 'BOSA', LoanApps."Loan  No.",
