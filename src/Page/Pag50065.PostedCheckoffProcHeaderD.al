...
Page 50065 "Posted Checkoff Proc. Header-D"
{
    DeleteAllowed = false;
    Editable = false;
    PageType = Card;
                    ...
                    if ReceiptLine.Find('-') then begin
                        repeat
                            ...
                            if Memb.Find('-') then begin
                                ...
                                ReceiptLine.TOTAL_DISTRIBUTED := ReceiptLine.Deposits + ReceiptLine.DL_P + ReceiptLine.DL_I + ReceiptLine.NL_P + ReceiptLine.NL_I + ReceiptLine.EMER_P + ReceiptLine.EMER_I + ReceiptLine.DeFL_P + ReceiptLine.DeFL_I +
                                ReceiptLine.MVL_P + ReceiptLine.MVL_I + ReceiptLine.EMER_P + ReceiptLine.EMER_I + ReceiptLine.INSURANCE + ReceiptLine.BENEVOLENT + ReceiptLine."Dependand Savings 3" + ReceiptLine.SAdvanceL_P + ReceiptLine.SAdvanceL_I + ReceiptLine.DhamanaL_P + ReceiptLine.DhamanaL_I +
                                ReceiptLine.HarakaL_P + ReceiptLine.HarakaL_I + ReceiptLine.SHARES;
                                ReceiptLine.Modify;
                            end;
                        until ReceiptLine.Next = 0;
                    end;
            ...
            action("Mark as Posted")
            {
                ...
                begin
                    if Confirm('Are you sure you want to mark this Checkoff as Posted ?', false) = true then begin
                        ReptProcHeader.Reset;
                        ReptProcHeader.SetRange(ReptProcHeader.No, Rec.Remarks);
