...
//         ObjPrPeriods: Record "Payroll Calender.";
...
//         AssignmentMatrix: Record "Payroll Transaction Code.";
...
//         TrainingRequests: Record "HR Training Applications";
//         hrsetup: Record "HR Setup";
//         ApprovalsMgt1: Codeunit WorkflowIntegration;
//         ApprovalMgt1: Codeunit WorkflowIntegration;
...
//         Trainingscehdule: Record "HR Training Applications";
//         currencycodes: Record Currency;
//         purchaseheader2: Record "Purchase Header";
//         PurchasesPayablesSetup: Record "Purchases & Payables Setup";
//         p9report: Record "Payroll Employee P9.";
...
//         PayrollEmployeeP9_AU6: Record "Payroll Employee P9.";
//         NNo: Code[10];
//         p9: Report P9Report;
...
//     procedure FnLeaveApplication(EmployeeNo: Code[100]; LeaveType: Code[100]; AppliedDays: Decimal; StartDate: Date; Reliever: Code[100]; pendingtasks: Text[2048])
//     var
...
//                 if ApprovalMgt1.CheckLeaveApplicationApprovalsWorkflowEnabled(variantrec) then
//                     ApprovalMgt1.OnSendLeaveApplicationForApproval(variantrec);
//             end;
//         end;
//     end;
...
//     procedure fnGetPayslip("Employee No": Code[20]; PayPeriod: Date; var BigText: BigText; Path: Text)
//     var
...
//         SalCard.SetFilter(SalCard."Current Month Filter", Format(PayPeriod));
//         if SalCard.Find('-') then begin
//             Report.SaveAsPdf(80013, Filename, SalCard);
//             // FileMode := 4;
//             // FileAccess := 1;
...
//           BEGIN
//             IF objHRLeaveApplication.Status=objHRLeaveApplication.Status::"Pending Approval" THEN
//               BEGIN
//                 variantrec:=objHRLeaveApplication;
//                 IF ApprovalMgt.CheckApprovalsWorkflowEnabled(variantrec) THEN
//                 ApprovalMgt.OnCancelDocApprovalRequest(variantrec);
//                 END;
//           END;
//           */
...
//     begin
//         if objHREmployees.Get(ApproverId) then begin
//             ObjApprovalEntries.Reset;
...
//             CreateJsonAttribute('Department', HREmployees."Shortcut Dimension 4 Code");
...
//     var
//         objPREmployee: Record "Payroll Employee.";
//         Filename: Text[100];
//         Convert: dotnet Convert;
//         _File: dotnet File;
//         FileAccess: dotnet FileAccess;
...
//     procedure fnGetP9Report("Employee No": Code[20]; "starting date": Date; "ending date": Date; var BigText: BigText; Path: Text)
//     var
//         objPREmployee: Record "Payroll Employee.";
//         Filename: Text[100];
//         Convert: dotnet Convert;
...
//     //Imprest
//     procedure FnInsertImprestRequisition(empNo: Code[50]; ProgrammeCode: Code[250]; Purpose: Text; MissionNarration: Text; FromDate: Date; EndDate: Date; Currency: Code[20]; ExpenseCode: Code[30]) returnout: Text
//     var
//         JsonOut: dotnet String;
//         purchaseHeader: Record "Purchase Header";
//         ObjHREmployee: Record "HR Employees";
...
//             // purchaseHeader."Type of Payment" := purchaseHeader."Type of Payment"::Imprest;
//             // purchaseHeader."Doc Type" := purchaseHeader."Doc Type"::PurchReq;
//             // purchaseHeader.Purpose := Purpose;
//             // purchaseHeader."Mission Naration" := MissionNarration;
//             // purchaseHeader."Employee No" := ObjHREmployee."No.";
...
//     procedure FnEditImprestRequisition(empNo: Code[50]; ProgrammeCode: Code[250]; Purpose: Text; MissionNarration: Text; FromDate: Date; EndDate: Date; Currency: Code[20]; No: code[20]; ExpenseCode: Code[30]) returnout: Text
//     var
//         JsonOut: dotnet String;
//         purchaseHeader: Record "Purchase Header";
//         ObjHREmployee: Record "HR Employees";
...
//     procedure FnInsertImprestRequisitionLines(No: Code[50]; AccountNo: Code[2000]; ImprestParticular: Text; Amount: Decimal; Project: Code[100];
...
//     procedure FnEditImprestRequisitionLines(No: Code[50]; AccountNo: Code[2000]; ImprestParticular: Text; Amount: Decimal; Project: Code[100];
...
//         if purchaseHeader.FindFirst() then begin
//             purchaseLine.Reset();
//             // purchaseLine.SetRange(purchaseLine."ShortcutDimCode[4]", Budget);
...
//     //Purchase Req
//     procedure FnInsertPurchaseRequisition(empNo: Code[50]; ProgrammeCode: Code[250]; Purpose: Text; FromDate: Date; EndDate: Date; Currency: Code[20]; ExpenseCode: Code[30]) returnout: Text
//     var
//         JsonOut: dotnet String;
//         purchaseHeader: Record "Purchase Header";
//         ObjHREmployee: Record "HR Employees";
...
//             //     purchaseHeader."Type of Payment" := purchaseHeader."Type of Payment"::PurchaseRequisition;
//             //     purchaseHeader."Doc Type" := purchaseHeader."Doc Type"::PurchReq;
//             //     purchaseHeader.Purpose := Purpose;
//             //     purchaseHeader."Payee Naration" := Purpose;
//             //     purchaseHeader."Employee No" := ObjHREmployee."No.";
...
//     procedure FnEditPurchaseRequisition(empNo: Code[50]; ProgrammeCode: Code[250]; Purpose: Text; FromDate: Date; EndDate: Date; Currency: Code[20]; No: code[20]; ExpenseCode: Code[30]) returnout: Text
//     var
//         JsonOut: dotnet String;
//         purchaseHeader: Record "Purchase Header";
//         ObjHREmployee: Record "HR Employees";
...
//             purchaseHeader."Document Date" := Today;
//             purchaseHeader.DocApprovalType := purchaseHeader.DocApprovalType::Purchase;
//             // purchaseHeader."Type of Payment" := purchaseHeader."Type of Payment"::General;
//             purchaseHeader."Doc Type" := purchaseHeader."Doc Type"::PurchReq;
...
//     end;
//     //Imprest Surrender
//     procedure FnInsertImprestSurrender(imprestno: Code[50]; empno: Code[50]) impsurrno: Code[50]
//     var
...
//                 // CreateJsonAttribute('ProjectTitle', ObjImprestHeader."Project Title");
//                 // CreateJsonAttribute('Country', ObjImprestHeader.Country);
...
//                 //CreateJsonAttribute('Type', standardtext.Type);
...
//                 //CreateJsonAttribute('Type', countryRegions.Type);
...
//         // CreateJsonAttribute('ProjectTitle', ObjImprestHeader."Project Title");
//         // CreateJsonAttribute('Country', ObjImprestHeader.Country);
//         // CreateJsonAttribute('County', ObjImprestHeader.Country);
//         // CreateJsonAttribute('DateOfActivity', ObjImprestHeader."Date(s) of Activity");
//         // CreateJsonAttribute('MissionTeam', ObjImprestHeader."Mission Team");
//         // CreateJsonAttribute('InvitedMembers', ObjImprestHeader."Invited Members/Partners");
//         // CreateJsonAttribute('FundCode', ObjImprestHeader."Shortcut Dimension 1 Code");
...
//                 CreateJsonAttribute('comments', approvalentries.Comments);
...
//         ObjDimensionValue.Reset;
//         ObjDimensionValue.SetRange("Global Dimension No.", 1);
//         ///ObjDimensionValue.SETRANGE("Budget Amount",fundCode);
//         if ObjDimensionValue.FindFirst then
//             repeat
//                 JSONTextWriter.WriteStartObject;
//                 CreateJsonAttribute('Code', ObjDimensionValue.Code);
...
//                 // CreateJsonAttribute('Name', ImprestHeader."No." + ' - ' + ImprestHeader."Payee Naration");
//                 JSONTextWriter.WriteEndObject;
...
//     procedure fnModifyTimesheetLines("code": Integer; from: DateTime; totime: DateTime; entryno: Integer; comments: Text; projectCode: Code[50]; projectText: Text; hours: Integer)
//     begin
//         // if TimeSheetLines.Get(entryno) then begin
//         //     TimeSheetLines.Timesheetcode := code;
//         //     TimeSheetLines.comments := comments;
//         //     TimeSheetLines.projectCode := projectCode;
//         //     TimeSheetLines.projectText := projectText;
//         //     TimeSheetLines.hours := hours;
...
//         if purchaseheader.Find('-') then begin
//             if purchaseheader.PR = true then
...
//             end;
//         end else begin
//             // if purchaseheader.IM = true then
...
//         //else begin
//         purchaseheader.reset;
//         // if purchaseheader.SR = true then
...
//         //end;
//         // end else begin
//         // if (purchaseheader.IM = false) and (purchaseheader.PR = false) and (purchaseheader.SR = false) then begin
//         // ExpenseReport.SetTableView(purchaseheader);
//         TempBlob.CreateOutStream(StatementOutstream);
//         // if ExpenseReport.SaveAs('', ReportFormat::Pdf, StatementOutstream) then begin
//         TempBlob.CreateInStream(StatementInstream);
//         Base64Txt := Base64Convert.ToBase64(StatementInstream, true);
//         // end;
...
//     procedure GenerateExpenseReport(documentNo: Code[40]; var Base64Txt: Text)
//     var
//         PurchaseHeader: Record "Purchase Header";
//         Filename: Text[100];
//         TempBlob: Codeunit "Temp Blob";
...
//     procedure fnInsertTimeSheet(name: Code[50]; projectCode: Code[40]; startdate: DateTime; employee: Code[50]; year: Integer; enddate: DateTime; hours: Integer) "code": Integer
//     var
//         noOfDays: Integer;
...
//         // TimesheetHeader.SetCurrentkey(Date, Description);
//         // TimesheetHeader.Ascending(true);
//         // if TimesheetHeader.Find('-') then begin
//         //     repeat
//         //         JSONTextWriter.WriteStartObject;

//         //         //CreateJsonAttribute('code', TimesheetHeader.Code);
//         //         JSONTextWriter.WritePropertyName('code');
//         //         JSONTextWriter.WriteValue(TimesheetHeader."Entry No.");
//         //         CreateJsonAttribute('name', '');
//         //         //  CreateJsonAttribute('startdate', TimesheetHeader."Start date");
//         //         JSONTextWriter.WritePropertyName('startdate');
//         //         JSONTextWriter.WriteValue(TimesheetHeader.Date);
//         //         JSONTextWriter.WritePropertyName('endDate');
//         //         JSONTextWriter.WriteValue(TimesheetHeader.Date);
//         //         JSONTextWriter.WritePropertyName('year');
//         //         JSONTextWriter.WriteValue(TimesheetHeader.Hours);
//         //         // CreateJsonAttribute('endDate', TimesheetHeader."End Date");
//         //         CreateJsonAttribute('projectCode', TimesheetHeader.Description);
//         //         CreateJsonAttribute('status', Format(TimesheetHeader.Status));
//         //         CreateJsonAttribute('entryNo', TimesheetHeader."Entry No.");
...
//     procedure fnVendors() returnout: Text
//     var
//         ObjDimensionValue: Record "Dimension Value";
//         JsonOut: dotnet String;
//         HRLeaveTypes: Record "HR Leave Types";
...
//             repeat
//                 JSONTextWriter.WriteStartObject;
//                 CreateJsonAttribute('Code', vendors."No.");
//                 CreateJsonAttribute('Name', vendors."Search Name");
//                 JSONTextWriter.WriteEndObject;
...
//                 // purchaseline."Travel Line Total" := purchaseline.Amount * purchaseline.noOfDays;
//                 // purchaseline."Amount Spent" := purchaseline.Amount * purchaseline.noOfDays;
//                 lineNo += 1000;
//                 if ModifyLineNo = 0 then
//                     purchaseline.Insert
//                 else
...
//                 // Evaluate(purchaseline.Amount, Format(lJObject.GetValue('amount')));
//                 // purchaseline."Travel Line Total" := purchaseline.Amount;
//                 // purchaseline."Amount Spent" := purchaseline.Amount;
//                 lineNo += 1000;
//                 if ModifyLineNo = 0 then
//                     purchaseline.Insert
//                 else
