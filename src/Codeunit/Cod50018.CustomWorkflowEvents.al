...
Codeunit 50018 "Custom Workflow Events"
{
    ...
    begin
        ...
        WFHandler.AddEventToLibrary(RunWorkflowOnSendJobApplicationForApprovalCode(),
                                    Database::"HR Jobss", 'Approval of Job Application is Requested.', 0, false);
        WFHandler.AddEventToLibrary(RunWorkflowOnCancelJobApplicationApprovalRequestCode(),
                                    Database::"HR Jobss", 'An Approval request for  Job Application is canceled.', 0, false);

        //hr job requisition Application

        WFHandler.AddEventToLibrary(RunWorkflowOnSendHREmployeeRequisitionForApprovalCode(),
                                    Database::"HR Employee Requisitions", 'Approval of hr employee is Requested.', 0, false);
        WFHandler.AddEventToLibrary(RunWorkflowOnCancelHREmployeeRequisitionRequestCode(),
                                    Database::"HR Employee Requisitions", 'An Approval request for  hr employee is canceled.', 0, false);

        //end
        //training
        WFHandler.AddEventToLibrary(RunWorkflowOnSendHRTrainingForApprovalCode(),
                                    Database::"HR Training Applications", 'Approval of Training Application is Requested.', 0, false);
        WFHandler.AddEventToLibrary(RunWorkflowOnCancelHRTrainingRequestCode(),
                                    Database::"HR Training Applications", 'An Approval request for  Training Application is canceled.', 0, false);
        //Loan Application
        ...
        //boardpayment
        WFHandler.AddEventToLibrary(RunWorkflowOnSendboardpaymentForApprovalCode,
                                           Database::"Boad Payments Allowance", 'Approval of board payment is Requested.', 0, false);
        WFHandler.AddEventToLibrary(RunWorkflowOnCancelboardpaymentApprovalRequestCode,
                                    Database::"Boad Payments Allowance", 'An Approval request for board payment is canceled.', 0, false);
    ...
    begin
        ...
        //JOB
        WFHandler.AddEventPredecessor(WFHandler.RunWorkflowOnApproveApprovalRequestCode, RunWorkflowOnSendJobApplicationForApprovalCode());
        WFHandler.AddEventPredecessor(WFHandler.RunWorkflowOnRejectApprovalRequestCode, RunWorkflowOnSendJobApplicationForApprovalCode());
        WFHandler.AddEventPredecessor(WFHandler.RunWorkflowOnDelegateApprovalRequestCode, RunWorkflowOnSendJobApplicationForApprovalCode());
        //hr job employee requisition
        ...
        WFHandler.AddEventPredecessor(WFHandler.RunWorkflowOnApproveApprovalRequestCode, RunWorkflowOnSendHRTrainingForApprovalCode());
        WFHandler.AddEventPredecessor(WFHandler.RunWorkflowOnRejectApprovalRequestCode, RunWorkflowOnSendHRTrainingForApprovalCode());
        WFHandler.AddEventPredecessor(WFHandler.RunWorkflowOnDelegateApprovalRequestCode, RunWorkflowOnSendHRTrainingForApprovalCode());
        ...
        //boardpayment
        WFHandler.AddEventPredecessor(WFHandler.RunWorkflowOnApproveApprovalRequestCode, RunWorkflowOnSendboardpaymentForApprovalCode);
        WFHandler.AddEventPredecessor(WFHandler.RunWorkflowOnRejectApprovalRequestCode, RunWorkflowOnSendboardpaymentForApprovalCode);
        WFHandler.AddEventPredecessor(WFHandler.RunWorkflowOnDelegateApprovalRequestCode, RunWorkflowOnSendboardpaymentForApprovalCode);
    ...
    //job 
    procedure RunWorkflowOnSendJobApplicationForApprovalCode(): Code[128]
    begin
        exit(UpperCase('RunWorkflowOnSendJobApplicationForApproval'));
    end;

    [EventSubscriber(ObjectType::Codeunit, Codeunit::WorkflowIntegration, 'OnSendJobApplicationForApproval', '', false, false)]

    procedure RunWorkflowOnSendJobApplicationForApproval(var HRJobss: Record "HR Jobss")
    begin

        WorkflowManagement.HandleEvent(RunWorkflowOnSendJobApplicationForApprovalCode(), HRJobss);
    end;

    procedure RunWorkflowOnCancelJobApplicationApprovalRequestCode(): Code[128]
    begin
        exit(UpperCase('RunWorkflowOnCancelJobApplicationApprovalRequest'));
    end;

    [EventSubscriber(ObjectType::Codeunit, Codeunit::WorkflowIntegration, 'OnCancelJobApplicationApprovalRequest', '', false, false)]

    procedure RunWorkflowOnCancelJobApplicationApprovalRequest(var HRJobss: Record "HR Jobss")
    begin
        WorkflowManagement.HandleEvent(RunWorkflowOnCancelJobApplicationApprovalRequestCode(), HRJobss);
    end;
    //end

    //hr employe requision
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::WorkflowIntegration, 'OnSendHREmployeeRequisitionApplicationForApproval', '', false, false)]

    procedure RunWorkflowOnSendHREmployeeRequisitionForApproval(var HREmployeeRequisitions: Record "HR Employee Requisitions")
    begin

        WorkflowManagement.HandleEvent(RunWorkflowOnSendHREmployeeRequisitionForApprovalCode(), HREmployeeRequisitions);
    end;

    procedure RunWorkflowOnCancelHREmployeeRequisitionRequestCode(): Code[128]
    begin
        exit(UpperCase('RunWorkflowOnCancelHREmployeeRequisitionRequest'));
    end;

    [EventSubscriber(ObjectType::Codeunit, Codeunit::WorkflowIntegration, 'OnCancelHREmployeeRequisitionApplicationApprovalRequest', '', false, false)]

    procedure RunWorkflowOnCancelHREmployeeRequisitionRequest(var HREmployeeRequisitions: Record "HR Employee Requisitions")
    begin
        WorkflowManagement.HandleEvent(RunWorkflowOnCancelHREmployeeRequisitionRequestCode(), HREmployeeRequisitions);
    end;
    //end
    ///traing needs
    procedure RunWorkflowOnSendHRTrainingForApprovalCode(): Code[128]
    begin
        exit(UpperCase('RunWorkflowOnSendHRTrainingForApproval'));
    end;

    [EventSubscriber(ObjectType::Codeunit, Codeunit::WorkflowIntegration, 'OnSendHRTrainingApplicationForApproval', '', false, false)]

    procedure RunWorkflowOnSendHRTrainingForApproval(var HRTrainingApplications: Record "HR Training Applications")
    begin

        WorkflowManagement.HandleEvent(RunWorkflowOnSendHRTrainingForApprovalCode(), HRTrainingApplications);
    end;

    procedure RunWorkflowOnCancelHRTrainingRequestCode(): Code[128]
    begin
        exit(UpperCase('RunWorkflowOnCancelHRTrainingnRequest'));
    end;

    [EventSubscriber(ObjectType::Codeunit, Codeunit::WorkflowIntegration, 'OnCancelHRTrainingApplicationApprovalRequest', '', false, false)]

    procedure RunWorkflowOnCancelHRTrainingnRequest(var HRTrainingApplications: Record "HR Training Applications")
    begin
        WorkflowManagement.HandleEvent(RunWorkflowOnCancelHRTrainingRequestCode(), HRTrainingApplications);
    end;
    ...
    //////////////////////////////////////////////////////////
    procedure RunWorkflowOnSendboardpaymentForApprovalCode(): Code[128]
    begin
        exit(UpperCase('RunWorkflowOnSendboardpaymentForApproval'));
    end;

    procedure RunWorkflowOnCancelboardpaymentApprovalRequestCode(): Code[128]
    begin
        exit(UpperCase('RunWorkflowOnCancelboardpaymentApprovalRequest'));
    end;

    [EventSubscriber(ObjectType::Codeunit, Codeunit::WorkflowIntegration, 'OnSendboardpaymentForApproval', '', false, false)]

    procedure RunWorkflowOnSendboardpaymentForApproval(var boardpayment: Record "Boad Payments Allowance")
    begin
        WorkflowManagement.HandleEvent(RunWorkflowOnSendboardpaymentForApprovalCode, boardpayment);
    end;

    [EventSubscriber(ObjectType::Codeunit, Codeunit::WorkflowIntegration, 'OnCancelboardpaymentApprovalRequest', '', false, false)]

    procedure RunWorkflowOncancelboardppaymentForApproval(var boardpayment: Record "Boad Payments Allowance")
    begin
        WorkflowManagement.HandleEvent(RunWorkflowOnCancelboardpaymentApprovalRequestCode, boardpayment);
    end;
        ...
        case RecRef.Number of
            ...
            Database::"Boad Payments Allowance":
                begin
                    ...
                    boardpayment.Validate(Status, boardpayment.Status::Pending);
    ...
    var
        WorkflowResponses: Codeunit "Custom Workflow Responses";
        ApprovaRe: Codeunit 1535;
    begin
        ApprovalEntry.Reset();
        ApprovalEntry.SetRange("Sequence No.", ApprovalEntry."Sequence No.");
        if ApprovalEntry.FindSet(true) then
            ...
            //ApprovaRe.ApproveApprovalRequests(ApprovalEntry);
            until ApprovalEntry.Next() = 0;
        exit;
        //WorkflowResponses.OnReleaseDocument();
    end;
