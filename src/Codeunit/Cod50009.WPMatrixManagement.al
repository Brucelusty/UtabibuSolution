...
Codeunit 50009 "WP Matrix Management"
{
    ...
    procedure SetPeriodColumnSet(DateFilter: Text[1024];PeriodType: enum "Analysis Period Type";Direction: Option Backward,Forward;var FirstColumn: Date;var LastColumn: Date;NoOfColumns: Integer)
    var
        Period: Record Date;
